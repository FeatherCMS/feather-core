...
public extension HookStorage {
    ...
    func registerAsync<ReturnType>(_ name: String,
        ...
        let pointer = HookFunctionPointer<AsyncHookFunction>(name: name,
                                                             function: function,
    ...
    func registerAsync<ReturnType>(_ hook: HookName, use block: @escaping AsyncHookFunctionSignature<ReturnType>, priority: Int = 100) {
        registerAsync(hook.description, use: block, priority: priority)
    }
}
