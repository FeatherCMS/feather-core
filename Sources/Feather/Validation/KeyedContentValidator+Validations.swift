...
public extension KeyedContentValidator where T == String {
    ...
    static func alphanumeric(_ key: String, _ message: String? = nil, optional: Bool = false) -> KeyedContentValidator<T> {
    ...
    static func email(_ key: String, _ message: String? = nil, optional: Bool = false) -> KeyedContentValidator<T> {
