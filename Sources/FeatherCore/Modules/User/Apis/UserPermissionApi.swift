...
struct UserPermissionApi: FeatherApi {
    ...
    func mapList(_ req: Request, model: Model) async throws -> UserPermission.List {
        .init(id: model.uuid, name: model.name)
    }
    
    func mapDetail(_ req: Request, model: Model) async throws -> UserPermission.Detail {
        .init(id: model.uuid,
    ...
    func mapCreate(_ req: Request, model: Model, input: UserPermission.Create) async throws {
    ...
    func mapUpdate(_ req: Request, model: Model, input: UserPermission.Update) async throws {
        model.namespace = input.namespace
        model.context = input.context
        model.action = input.action
        model.name = input.name
    ...
    func mapPatch(_ req: Request, model: Model, input: UserPermission.Patch) async throws {
